...
import {
  ...
  RefreshCw, Trophy, Sparkles, Check, AlertTriangle,
  Code, User, Lightbulb, Clock, Star, Bolt,
  CheckCircle, Award, FileText, Send
} from "lucide-react"
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-20">
          ...
          <div className="text-center">
            <p className="text-base font-medium text-slate-700">
              Claude AI is preparing your interview questions...
            </p>
            <p className="text-xs text-slate-500 mt-1">
              5 written + 5 voice questions personalized to your CV
            </p>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="mx-auto max-w-5xl">
        <div className="rounded-xl border border-red-200 bg-red-50 p-8 text-center">
          ...
          <Link href="/analyze" className="rounded-lg bg-teal-700 px-6 py-2.5 text-sm font-medium text-white">
            Analyze CV first
          </Link>
        </div>
      </div>
    ...
    <div className="mx-auto max-w-5xl space-y-4">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-semibold text-slate-900">Interview Preparation</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="rounded-xl border border-teal-200 bg-white p-3">
          ...
          <div className="text-xl font-medium text-slate-900">{answered} / 10</div>
        ...
        <div className="rounded-xl border border-teal-200 bg-white p-3">
          ...
          <div className="text-xl font-medium text-slate-900">{avgScore.toFixed(1)}</div>
        ...
        <div className="rounded-xl border border-teal-200 bg-white p-3">
          ...
          <div className="text-xl font-medium text-slate-900">{avgConfidence.toFixed(0)}%</div>
        ...
        <div className="rounded-xl border border-teal-200 bg-white p-3">
          ...
          <div className="text-xl font-medium text-slate-900">{currentIndex + 1} / 10</div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className={`rounded-xl border bg-white p-3 flex items-center gap-3 ${question.mode === "written" ? "border-violet-300 border-2 bg-gradient-to-br from-violet-50 to-white" : "border-slate-200"}`}>
          ...
          <span className="bg-teal-700 text-white text-[10px] px-2 py-0.5 rounded-full font-medium">{writtenCount}</span>
        </div>
        <div className={`rounded-xl border bg-white p-3 flex items-center gap-3 ${question.mode === "voice" ? "border-amber-300 border-2 bg-gradient-to-br from-amber-50 to-white" : "border-slate-200"}`}>
          ...
          <span className="bg-teal-700 text-white text-[10px] px-2 py-0.5 rounded-full font-medium">{voiceCount}</span>
        </div>
      </div>

      {/* Question card */}
      <div className="relative overflow-hidden rounded-xl border border-teal-200 bg-white p-5 shadow-sm">
        ...
        <div className="relative z-10 flex items-start gap-3 mb-4">
          <div className="h-9 w-9 rounded-full bg-gradient-to-br from-teal-700 to-teal-900 text-white flex items-center justify-center font-medium text-sm">
            {question.index + 1}
          </div>
          <div className="flex-1">
            ...
            {question.hint && (
              <p className="text-xs text-slate-500 italic mt-2">💡 {question.hint}</p>
            )}
          </div>
        </div>
        ...
        {question.mode === "written" ? (
          <div className="relative z-10">
            <textarea
              ...
              className="w-full min-h-[120px] p-3 border border-slate-200 rounded-lg text-sm focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none resize-y"
            />
          ...
          <div className="relative z-10 rounded-xl border-2 border-dashed border-rose-300 bg-gradient-to-b from-rose-50 to-white p-6 text-center">
            <button
              ...
              className={`relative inline-flex h-20 w-20 items-center justify-center rounded-full text-white shadow-lg ${
                isRecording
                  ? "bg-gradient-to-br from-red-500 to-red-700 animate-pulse"
                  : "bg-gradient-to-br from-red-500 to-red-700 hover:scale-105 transition-transform"
              }`}
            >
            ...
            {isRecording && (
              <div className="flex items-center justify-center gap-1 mt-3 h-6">
                {[...Array(10)].map((_, i) => (
                  <div
                    key={i}
                    className="w-1 bg-gradient-to-b from-red-500 to-teal-400 rounded animate-pulse"
                    style={{
            ...
            {audioBlob && !isRecording && (
              <div className="flex justify-center gap-2 mt-3">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 rounded-md text-xs text-slate-700"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-teal-700 text-white rounded-md text-xs disabled:opacity-50"
                >
                  {evaluating ? (
            ...
            {transcript && (
              <div className="mt-3 p-2 bg-white border border-slate-200 rounded text-left">
        ...
        {/* Evaluation */}
        {evaluation && (
          <div className="relative z-10 mt-4 rounded-xl border border-teal-200 bg-gradient-to-b from-teal-50 to-white p-4">
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-teal-100">
              ...
              <div className="flex items-center gap-1.5 bg-gradient-to-r from-teal-700 to-teal-900 text-white px-3 py-1 rounded-full text-sm font-medium">
            ...
            <div className="grid grid-cols-3 gap-2 mb-3">
              {[
                ...
                <div key={m.label} className="bg-white rounded-md p-2.5 text-center border border-slate-100">
                  ...
                  <div className="text-lg font-medium text-slate-900">{m.value}%</div>
                  ...
                  <div className="h-1 bg-slate-100 rounded mt-1.5 overflow-hidden">
                    <div className={`h-full bg-${m.color}-500 rounded`} style={{ width: `${m.value}%` }} />
                  </div>
                </div>
              ))}
            </div>
            ...
            {question.mode === "voice" && evaluation.pace_analysis && (
              <div className="bg-gradient-to-b from-amber-50 to-white border-l-4 border-amber-400 rounded p-3 mb-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50"
        >
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-teal-700 px-4 py-2.5 text-sm font-medium text-white hover:bg-teal-800 disabled:opacity-50"
        >
          Next question
